...
public class SearchDrug extends javax.swing.JFrame {
                ...
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 691,
                                                Short.MAX_VALUE)
                                        .addGroup(jPanel3Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel3Layout
                                                        ...
                                                        .addComponent(name, javax.swing.GroupLayout.PREFERRED_SIZE, 160,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel2)
                                        .addComponent(drugbarcode, javax.swing.GroupLayout.PREFERRED_SIZE,
    ...
    private void drugbarcodeKeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_drugbarcodeKeyReleased
        String sql = "select NAME,TYPE,BARCODE,SELLING_PRICE,PLACE,EXPIRY from drugs where BARCODE REGEXP '"
                + drugbarcode.getText() + "' ";
        try {
            pre = con.prepareStatement(sql); // prepare statment sql usgin barcode (when you type barcode it will
                                             // display the result automatic)
    ...
    private void nameKeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_nameKeyReleased
        String sql = "select NAME,TYPE,BARCODE,SELLING_PRICE,PLACE,EXPIRY from drugs where NAME REGEXP '"
                + name.getText() + "' ";
        try {
            pre = con.prepareStatement(sql);// prepare statment sql usgin name (when you type name it will display the
                                            // result automatic)
            res = pre.executeQuery();// execute the swl statement
            searching.setModel(DbUtils.resultSetToTableModel(res));// set data in table
        } catch (Exception e) {
