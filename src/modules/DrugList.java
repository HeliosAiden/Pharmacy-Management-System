...
public class DrugList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        druglist.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "         Name", "         Type", "         Barcode", "         Price", "         Expiry",
                        "         Company"
                }) {
        ...
        sort_by.setModel(
                new javax.swing.DefaultComboBoxModel<>(new String[] { "Sort By : ", "Name", "Type", "Expiration" }));
        ...
        jPanel4Layout.setHorizontalGroup(
                jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addComponent(sort_by, javax.swing.GroupLayout.PREFERRED_SIZE, 154,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
                ...
                jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel2)
                                        .addComponent(sort_by, javax.swing.GroupLayout.PREFERRED_SIZE,
    ...
    private void drug_list() { // this method will be executed when you click on drug_list
        String sql = "select NAME , TYPE ,BARCODE,SELLING_PRICE , EXPIRY , COMPANY_NAME from drugs"; // get data from
                                                                                                     // database
        try {
