...
public class ExpiredDrug extends javax.swing.JFrame  {
    Connection con = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExpiredDrug.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
